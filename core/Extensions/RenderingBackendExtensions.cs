...
namespace Rendering
{
    public static class RenderingBackendExtensions
    {
        ...
        public static void Render<T>(this ref T backend, in Allocation renderer, in USpan<uint> entities, in MaterialData material, in MeshData mesh, in VertexShaderData vertexShader, in FragmentShaderData fragmentShader) where T : unmanaged, IRenderingBackend
        {
